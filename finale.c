...
void print_top_ten(word_list_t* L){
	...
	// 	count++;
	// 	if(count>=11){
	// 		greater_than_ten_flag = 1;
	// 		printf("greater than 10 words\n" );
	// 		break;
	// 	}
	// 	curr=curr->next;
	// }
	// if(greater_than_ten_flag==0){
	// 	printf("less than 10 words\n");
	// 	print_word_list(L);
	// }
	// else{
		//to do   --->find max and delete---> do this 10 times!!
...
int main(int argc, char** argv){
    ...
    // scanf("%s", mpath);
    // printf("enter number of worker threads N: ");
    tf = cfil(mpath);
    printf("total files to be processed: %ld\n",tf );
